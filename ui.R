...
#The following creates the modeling page;
    tabItem(tabName = "fourth",
            ...
            h4("The tree model creates a decision tree.  The tree bag model does not have a decision tree.  The tree can be save by right clicking on the graph and clicking on save                   image as"),
            br(),
...
#This tab allows the user to see the data in a table and download the data  
  #Data page with subsetting
    tabItem(tabName = "fifth",
            h1("Project Data"),
            br(),
            h4("The data can be subsetted here.  The Target is the response. The download button downloads the selected data from the dataset."),
            br(),
            pickerInput("select5","columns to display", choices=names(data1), options = list(`actions-box` = TRUE),multiple = T),
